 ...
 */
public class CartoonNewsAdapter extends RecyclerView.Adapter<CartoonNewsAdapter.ArticleNewsViewHolder> {

    private Activity activity;
    private List<CartoonEntity> dataList;
    private boolean isPullRefreshEnable;

    public CartoonNewsAdapter(Activity activity, List<CartoonEntity> dataList, boolean isPullRefreshEnable) {
    ...
    public ArticleNewsViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.cartoon_news_list_item, parent, false);
    ...
    public void onBindViewHolder(final ArticleNewsViewHolder holder, final int pos) {
        ...
        holder.tvTitle.setText(dataList.get(pos).cartoonTitle);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                CartoonDetailActivity.start(activity,
