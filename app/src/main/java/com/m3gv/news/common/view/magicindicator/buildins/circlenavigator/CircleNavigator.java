package com.m3gv.news.common.view.magicindicator.buildins.circlenavigator;
...
import com.m3gv.news.common.view.magicindicator.NavigatorHelper;
import com.m3gv.news.common.view.magicindicator.abs.IPagerNavigator;
...
public class CircleNavigator extends View implements IPagerNavigator, NavigatorHelper.OnNavigatorScrollListener {
    ...
    private void init(Context context) {
        ...
        mRadius = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 3, Resources.getSystem().getDisplayMetrics());
        mCircleSpacing = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 8, Resources.getSystem().getDisplayMetrics());
        mStrokeWidth = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 1, Resources.getSystem().getDisplayMetrics());
    }
